// To insert in "seeds/movies.seed.js" -- inserted here as best practice
const movies = [
    {
...
/*   // get the movie model
  ...
  //use the schema to create movies: //we do a forEach on the movie Array above and put them into our MongoDB
  movies.forEach(async (movie) => {
    await Movie.create(movie);
  }); */ //--> this part is commented out once we have already sent the data to MongoDB, otherwise it will keep doing this
  //each time you start the MongoDB
